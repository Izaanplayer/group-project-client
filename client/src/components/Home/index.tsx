            ...
            <div className="flex h-screen flex-col">
                <div className="flex flex-row h-full items-center w-full z-40">
                    ...
                    <div className="w-1/2 px-7">
                        ...
                        <Link to="/artists">
                            <button className="inline-block px-10 py-2 ml-2 text-sm font-medium text-white bg-red-500 rounded-lg border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 float-right">Descrubrir artistas</button>
                        </Link>
                    </div>
                </div>
